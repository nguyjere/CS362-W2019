...
int main() {
	...
	for (int i = 0; i < numOfTests; i++)
	{
		...
		res = cardEffect(adventurer, choice1, choice2, choice3, &G, G.handCount[G.whoseTurn]-1, &bonus);
		...
		assertEqual(G.playedCards[G.playedCardCount - 1], adventurer, "Adventurer was not moved to played pile", &testRes);
